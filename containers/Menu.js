	...
	render() {
        ...
        <aside className={classes} id="nav">
            <section className="vbox">
              <header className="header bg-info brand-header lock-header pos-stat clearfix">
                ...
                <div className="text-center tophead">
                  ...
                  <span className="text-center" style={{lineHeight: '21px', fontWeight:'bold'}}>ICarros</span>
                </div>
              </header>
